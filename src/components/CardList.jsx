    ...
    <Fade show={maximized} delay={maximized ? 400 : 0}>
      <div className="details">
        ...
        <div className="close">
           ...
           <div  type="close" style={{ cursor: 'pointer' }} onClick={toggle}   >X </div>
         </div>
          <h1>{name} maso</h1>
          <img width="80%" src="https://image.shutterstock.com/image-vector/happy-blue-bird-cartoon-flying-600w-437415406.jpg" />
...
class CardList extends Component {
  state = { data, columns: 1, margin: 70, filter: '', height: true }
